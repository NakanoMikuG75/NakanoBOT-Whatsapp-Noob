    ...
    nakano.onGlobalParticipantsChanged(async (event) => {
        ...
        try {
            if (event.action === 'add' && event.who !== botNumbers && isWelcome) {
                ...
                if (pic === undefined) {
                    var picx = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTQcODjk7AcA4wb_9OLzoeAdpGwmkJqOYxEBA&usqp=CAU', 'profile.jpg'
                } else {
                    picx = pic
                }
                ...
                const pic = await nakano.getProfilePicFromServer(event.who)
                if (pic === undefined) {
                    var picxs = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTQcODjk7AcA4wb_9OLzoeAdpGwmkJqOYxEBA&usqp=CAU', 'profile.jpg'
                } else {
                    picxs = pic
                }
