...
exports.botNotAdmin = () => {
    return `Untuk menggunakan fitur ini bot harus menjadi admin!`
}
...
exports.notRegistered = () => {
    return `Hai Minna\nKamu belum terdaftar sebagai taman Nakano-Miku BOT\nUntuk mendaftar silahlan kirim *${prefix}register* nama | umur\n\nContih format *${prefix}register* NakanoMIKU | 17\n\ncukup gunakan nama depan / panggil saja!`
}

exports.registered = (name, age, userId, time, serial) => {
    return `\`\`\`╭─「 VERIFY-SUCCES 」\`\`\`\n│\n├[Nama]: ${name}\n├[Umur]: ${age}\n├[Id]: ${userId}\n├[Serial]: ${serial}\n├[Waktu] ${time}\n│\n├Sebelum menggunakan bot silahkan\n│kirim ${prefix}rules│Thanks sudh pake bot ini~\`\`\``
}
...
exports.limit = () => {
    return `
_Maaf limit kamu sudah habis harap tunggu hingga pukul 21:00wib limit akan di reset!_
    `
}
...
Ketik *${prefix}menu* angka untuk melihat menu yg terdaftar!.

Note:
Apa bila kamu melanggar rules kamu akan di banned dan harap beri jeda 5 detik setiap sekali pemakaian!.
Dan apa bilang kamu menelfon bot kamu akan di blockir permanen!.
    `
}
...
Bot ini merupakan open-source bot dengan nama asli NakanoBot yang tersedia di GitHub secara gratis.
...
https://github.com/ffhitmanff/NakanoBOT-Whatsapp-Noob

Contact person:
wa.me/${ownerNumber.replace('@c.us', '')} (Owner/hoster) 

Dukung saya dengan cara donasi ke:
https://saweria.co/HITMANFF
